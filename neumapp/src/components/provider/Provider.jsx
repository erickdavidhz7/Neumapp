  ...
  return (
    <div className="bg-slate-300 w-[50%] h-[400px] rounded-tr-2xl rounded-br-2xl">
      <div className="flex flex-col items-center justify-center h-full">
        <h3 className="text-white text-4xl text-center font-bold mb-5">
          Maria está en camino, pronto llegará!
        </h3>
  ...
  return (
    <div className="bg-slate-300 w-[50%] h-[400px] rounded-tr-2xl rounded-br-2xl">
      <div className="flex flex-col items-center justify-around h-full">
        <h3 className="text-slate-700 text-2xl text-center font-bold mb-5 w-[80%]">
          Tu servicio ha finalizado. Por favor califica al prestador.
        </h3>
        ...
        <div className="w-[80%] text-center">
          ...
          <input
            className="w-full h-10 bg-slate-700 mt-4 rounded-2xl text-white text-center"
            type="text"
          />
        </div>
...
export function Provider({ position, state }) {
  return (
    <>
      <div
        style={{ position: position, top: "185px", left: "150px" }}
        className="flex flex-row items-center justify-center rounded w-[80%] position-absolute"
      >
        ...
        {state ? (
          ...
          <ProviderCommingSoon></ProviderCommingSoon>
        )}
      </div>
    </>
  );
